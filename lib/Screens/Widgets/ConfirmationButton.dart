    ...
    return ElevatedButton(
                ...
                if (Text_Field == 'CU') {
                  ...
                  for (i; i < inputTexts!.length; i++) {
                    ...
                    if (text.isEmpty) {
                      ...
                      showDialog(
                          context: context,
                          builder: (context) => Fail_Notification(
                                tituloFN: 'Error',
                    ...
                    if (nextB == true) {
                      ...
                      CreateAccount(
                          'https://eouww9yquk.execute-api.us-east-1.amazonaws.com/user/add',
                  ...
                  for (i; i < inputTexts!.length; i++) {
                    ...
                    if (text.isEmpty) {
                      ...
                      showDialog(
                          ...
                          builder: (context) => Fail_Notification(
                                tituloFN: 'Error',
                                mensajeFN:
                                    'Haz dejado un espacio en blanco para tu mascota',
                              ));
                      nextB = false;
                      //return;
                      break;
                    ...
                    if (nextB == true) {
                      ...
                      CreatePet(
                          'https://eouww9yquk.execute-api.us-east-1.amazonaws.com/pets/add_pet',
                          jsonDataP);
                  ...
                  for (i; i < inputTexts!.length; i++) {
                    ...
                    if (text.isEmpty) {
                      ...
                      // Imprimir el texto en la consola si no está vacío
                      print(
                          'Texto ingresado en Editar Usuario ${i + 1}: $text');
                      nextB = true;
                    }
                    ...
                    if (nextB == true) {
                      ...
                      EdditAccount(inputTexts![5], jsonData);
                  ...
                  for (i; i < inputTexts!.length; i++) {
                    ...
                    if (nextB == true) {
                      ...
                      dataLogIn(
                          'https://eouww9yquk.execute-api.us-east-1.amazonaws.com/user/login',
                          jsonData);
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(
            horizontal: 4.0,
            vertical: 4.0), // Ajusta el espacio aquí según sea necesario
        child: Text(
          TextButton,
          style: TextStyle(
            fontSize: 15.0,
