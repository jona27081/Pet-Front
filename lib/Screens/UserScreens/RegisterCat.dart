...
class Register_Cat extends StatefulWidget {
  @override
  State<Register_Cat> createState() => _Register_CatState();
}

class _Register_CatState extends State<Register_Cat> {
                  ...
                  additionalFunction: () {
                    setState(() {
                      List<String> FieldT = [
                        ...
                        _controller3.text,
                        selectedItem,
                        ref.read(userDataNotifierProvider).id!
                      ];
