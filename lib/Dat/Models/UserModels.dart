...
Future<void> dataLogIn(String url, Map<String, dynamic> jsonData) {
  return post_LogInAccount(url, jsonData);
}

///POST
Future<void> CreateAccount(String url, Map<String, dynamic> jsonData) {
  return post_CreateAccount(url, jsonData);
}

Future<void> CreatePet(String url, Map<String, dynamic> jsonData) {
  return post_CreatePet(url, jsonData);
}
//

///GET
Future<dynamic> GetAccountPets(String urlid) {
  String url =
      'https://eouww9yquk.execute-api.us-east-1.amazonaws.com/pets/get_pets_user?id=$urlid';
...
///PUT
Future<void> EdditAccount(String urlid, Map<String, dynamic> jsonData) {
  String url =
      'https://eouww9yquk.execute-api.us-east-1.amazonaws.com/user/update_user?id=$urlid';
...
///DEL
Future<void> DeleteAccount(String urlid) {
  String url =
      'https://eouww9yquk.execute-api.us-east-1.amazonaws.com/user/delete_acount?id=$urlid';
  print('Eliminando...');
